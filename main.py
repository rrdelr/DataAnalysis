from funcs import to_df, info, gen_scat, wrose, sep_df, box_plot, avg_plot, gen_vs, heat, compare, heat_mixed
...
heat_mixed((df_t1[['Date', ' WIND_SPEED', ' ROTOR_SPEED', ' V_OUT']], df_t2[['Date', ' WIND_SPEED', ' ROTOR_SPEED', ' V_OUT']]))